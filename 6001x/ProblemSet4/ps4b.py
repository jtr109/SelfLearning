...
def compPlayHand(hand, wordList, n):
    ...
    while True:
        ...
        exist_vowel = False
        for letter in hand:
            if hand[letter] > 0 and letter in VOWELS:
                exist_vowel = True
                break
        if exist_vowel is False:
            break
        # compute the best hand
...
def playGame(wordList):
    ...
    hand = {}
    while True:
        choose_hand = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game:\n')
        if choose_hand == 'n':
            # deal a new hand
...
def choosePlayer(hand, wordList, n):
    while True:
        choose_player = raw_input('Enter u to have yourself play, c to have the computer play: ')
        if choose_player == 'u':
